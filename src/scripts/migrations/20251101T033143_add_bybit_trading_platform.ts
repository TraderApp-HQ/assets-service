...
export async function up() {
	console.log("Running migration: 20251101T033143_add_bybit_trading_platform.ts");
	...
	console.log(
		"Migration completed successfully for: 20251101T033143_add_bybit_trading_platform.ts"
	);
}

export async function down() {
	console.log("Rolling back migration: 20251101T033143_add_bybit_trading_platform.ts");
	...
	console.log(
		"Rollback completed successfully for: 20251101T033143_add_bybit_trading_platform.ts"
	);
}
