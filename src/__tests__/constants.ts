...
export const bitcoinSignalData = {
	...
	supportedExchanges: [exchangeData._id],
	asset: bitcoinCoinData._id,
	assetName: bitcoinCoinData.symbol,
	baseCurrency: baseCurrencyData._id,
	baseCurrencyName: baseCurrencyData.symbol,
	category: Category.CRYPTO,
...
export const cadanoSignalData = {
	...
	createdAt: new Date().toISOString(),
	supportedExchanges: [exchangeData._id],
	asset: cadanoCoinData._id,
	assetName: cadanoCoinData.symbol,
	baseCurrency: baseCurrencyData._id,
	baseCurrencyName: baseCurrencyData.symbol,
	category: Category.CRYPTO,
	tradeType: TradeType.FUTURES,
